...
def login():
    ...
    while valid_user_and_pass == False:    
        # Open the file
        userfile = open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\user.txt", 'r+', encoding='utf-8')
        # Using a global username variable for use later
        global username_i
        username_i = input("Please enter your username: ")
...
# Register a user
def reg_user():   
    userfile = open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\user.txt", 'a+', encoding='utf-8')
...
# Add a task
def add_task():
    with open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\tasks.txt", 'a+', encoding='utf-8') as taskfile:
...
def task_dict():
    with open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\tasks.txt", 'r', encoding='utf-8') as taskfile:
            task_dictionary = {}
...
def user_dict():
    with open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\user.txt", 'r', encoding='utf-8') as userfile:
            user_dictionary = {}
...
def view_all():
    with open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\tasks.txt", "r") as f:
        data = f.readlines()
    ...
    for count in data:
        ...
        print(f"Name:{count[0]} Task: \t{count[1]}")
...
def edit_user_task(x,dictionary): 
    ...
    with open(r"C:\Users\User\Dropbox\Gerhard Kotze-56978\Introduction to Programming\Task 20\tasks.txt", 'w', encoding='utf-8') as task_file:
